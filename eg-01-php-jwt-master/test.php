...
class DocuSignSample
{
    ...
    {
        $username = "nc@isolutionstechnology.com.au";
        $password = "##DEV1++!!@@";
        $integrator_key = "70208536-95f1-4816-9bb3-840b16c3f285";     
            ...
            if(isset($loginInformation) && count($loginInformation) > 0)
            {
                ...
                if(isset($loginInformation))
                {
                    ...
                    if(!empty($accountId))
                    {
                        ...
                        $templateRole->setEmail("nc@isolutionstechnology.com.au");
                        $templateRole->setName("NC");
                        $templateRole->setRoleName("Manager");             
